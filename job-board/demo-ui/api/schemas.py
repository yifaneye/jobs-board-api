...
definitions = {'definitions': {'Job': {'type': 'object', 'properties': {'id': {'type': 'integer', 'example': 1}, 'name': {'type': 'string', 'example': 'Developer'}}}}, 'parameters': {}}

validators = {
    ('job', 'POST'): {'json': {'$ref': '#/definitions/Job'}},
}

filters = {
    ('job', 'POST'): {201: {'headers': None, 'schema': None}, 405: {'headers': None, 'schema': None}},
    ('job', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Job'}}}, 404: {'headers': None, 'schema': None}},
}
